...
const processComments = comments => {
  return comments.map(comment =>
    Object.assign(Object.assign({}, comment), {
...
const renderComment = (data, parentId = 0) => {
  ...
  return `
    <div class="bg-white md:gap-5 p-4 md:p-6 rounded-lg md:flex shadow-md mb-4">
        ...
        <div class="text-blue-700 flex justify-between md:hidden">
...
const renderReply = (btn_1, ...args_1) =>
  __awaiter(this, [btn_1, ...args_1], void 0, function* (btn, commentId = 0) {
...
const vote = (id, op, parentId) =>
  __awaiter(this, void 0, void 0, function* () {
    ...
    const updateComment = yield fetch(
      `http://localhost:${portNo}/comments/${userId}`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
...
const showReply = id =>
  __awaiter(this, void 0, void 0, function* () {
    ...
    const commentElement =
      document.querySelectorAll("div.bg-white.p-4")[id - 1];
...
const renderCTA = (user, data, parentId) =>
...
const displayContents = () =>
  __awaiter(this, void 0, void 0, function* () {
    ...
    (_a = document.querySelector(".reply-btn")) === null || _a === void 0
      ? void 0
      : _a.addEventListener("click", addComment);
  });
displayContents();
